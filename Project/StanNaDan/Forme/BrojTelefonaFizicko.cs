...
{
    public partial class BrojTelefonaFizicko : Form
    {
        VlasnikBasic vlasnik;
        public BrojTelefonaFizicko()
        {
            InitializeComponent();
        }

        public BrojTelefonaFizicko(VlasnikBasic v)
        {
            InitializeComponent();
            vlasnik = v;
        }
        ...
        private void BrojTelefonaFizicko_Load(object sender, EventArgs e)
        {
